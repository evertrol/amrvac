...
contains
  ...
  subroutine get_surface_area(s,ixGmin1,ixGmin2,ixGmin3,ixGmax1,ixGmax2,&
    ...
    double precision :: x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,ixGmin3:ixGmax3,&
       ...
       ixGmin3:ixGmax3)
    ! ER: exp_factor & variations unused?
  ...
  subroutine gradientx(q,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    case(Cartesian)
      if(fourth_order) then
        ...
        kxOmin1=ixOmin1-2;kxOmin2=ixOmin2-2;kxOmin3=ixOmin3-2
        kxOmax1=ixOmax1+2;kxOmax2=ixOmax2+2;kxOmax3=ixOmax3+2;
  ...
  !> Calculate gradient of a scalar q in direction idir at cell interfaces
  subroutine gradientq(q,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
     ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idir,gradq)
    use mod_global_parameters
    ...
    jxOmin1=ixOmin1;jxOmin2=ixOmin2;jxOmin3=ixOmin3;jxOmax1=ixOmax1
    jxOmax2=ixOmax2;jxOmax3=ixOmax3;
    hxOmin1=ixOmin1-kr(idir,1);hxOmin2=ixOmin2-kr(idir,2)
    hxOmin3=ixOmin3-kr(idir,3);hxOmax1=ixOmax1-kr(idir,1)
    hxOmax2=ixOmax2-kr(idir,2);hxOmax3=ixOmax3-kr(idir,3);
    select case(coordinate)
