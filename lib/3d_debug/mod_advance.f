...
contains
  ...
  subroutine advect1(method,dtfactor,idimmin,idimmax,qtC,psa,qt,psb)
    ...
    double precision :: fC(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,1:nwflux,&
       1:ndim)
    ! cell edge flux
    double precision :: fE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,ixGlo3:ixGhi3,sdim:3)
    ...
    do iigrid=1,igridstail_active; igrid=igrids_active(iigrid);
      ...
      call advect1_grid(method(block%level),qdt,dtfactor,ixGlo1,ixGlo2,ixGlo3,&
         ixGhi1,ixGhi2,ixGhi3,idimmin,idimmax,qtC,psa(igrid),qt,psb(igrid),fC,&
         fE,rnode(rpdx1_:rnodehi,igrid),ps(igrid)%x)
      ...
      if (fix_conserve_global .and. fix_conserve_at_step) then
        ...
        if(stagger_grid) call store_edge(igrid,ixGlo1,ixGlo2,ixGlo3,ixGhi1,&
           ixGhi2,ixGhi3,fE,idimmin,idimmax)
      end if
  ...
  subroutine advect1_grid(method,qdt,dtfactor,ixImin1,ixImin2,ixImin3,ixImax1,&
     ixImax2,ixImax3,idimmin,idimmax,qtC,sCT,qt,s,fC,fE,dxs,x)
    ...
    double precision :: fC(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
       1:nwflux,1:ndim), wprim(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
       1:nw)
    ...
    case (fs_hll,fs_hllc,fs_hllcd,fs_hlld,fs_tvdlf,fs_tvdmu)
       call finite_volume(method,qdt,dtfactor,ixImin1,ixImin2,ixImin3,ixImax1,&
          ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,&
          idimmin,idimmax,qtC,sCT,qt,s,fC,fE,dxs,x)
    case (fs_cd,fs_cd4)
       call centdiff(method,qdt,dtfactor,ixImin1,ixImin2,ixImin3,ixImax1,&
          ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,&
          idimmin,idimmax,qtC,sCT,qt,s,fC,fE,dxs,x)
    case (fs_hancock)
       call hancock(qdt,dtfactor,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
          ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idimmin,&
          idimmax,qtC,sCT,qt,s,dxs,x)
    case (fs_fd)
       call fd(qdt,dtfactor,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
          ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,idimmin,idimmax,qtC,&
          sCT,qt,s,fC,fE,dxs,x)
    case (fs_tvd)
       call centdiff(fs_cd,qdt,dtfactor,ixImin1,ixImin2,ixImin3,ixImax1,&
          ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,&
          idimmin,idimmax,qtC,sCT,qt,s,fC,fE,dxs,x)
    ...
    case (fs_source)
       ...
       call addsource2(qdt*dble(idimmax-idimmin+1)/dble(ndim),&
          dtfactor*dble(idimmax-idimmin+1)/dble(ndim),ixImin1,ixImin2,ixImin3,&
          ixImax1,ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,&
          ixOmax3,1,nw,qtC,sCT%w,wprim,qt,s%w,x,.false.)
    case (fs_nul)
